...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $cat['dirPath']        = !empty($_FILES['dirPath'])        ? load_img($_FILES)        : '';
//     echo load_img($_FILES);
//     var_dump($_FILES);
//     exit;
...
function load_img($f)
{
	...
	if(is_uploaded_file($f['dirPath']['tmp_name'])){
		...
		$photo_folder2 = "upload/".date("Y")."/".date("m")."/".date("d")."/"; //上传照片路径
		///////////////////////////////////////////////////开始处理上传
...
// 		echo $photo_folder.$fname;
		return $photo_folder2.$fname;   //echo " 已经成功上传：".$photo_server_folder."<br />";

...
// $modules['05_system']['storage'] = 'storage.php?act=list';
// $modules['05_system']['storage_goods'] = 'storage_goods.php?act=list';
...
// $modules['04_order']['11_share_order']               = 'share.php?act=share_list';
// $modules['04_order']['12_share_comment']               = 'share_comment_manage.php?act=list';

// $modules['05_banner']['ad_position']                = 'ad_position.php?act=list';
$modules['11_banner']['ad_list']                    = 'ads.php?act=list';
...
// $modules['08_members']['11_to_user']    = 'to_user.php?act=list_all';
...
// $modules['05_system']['01_shop_config']             = 'shop_config.php?act=list_edit';
// $modules['05_system']['shop_authorized']             = 'license.php?act=list_edit';
// // $modules['05_system']['02_payment_list']            = 'payment.php?act=list';
// // $modules['05_system']['03_shipping_list']           = 'shipping.php?act=list';
// $modules['05_system']['04_mail_settings']           = 'shop_config.php?act=mail_settings';
// $modules['05_system']['05_area_list']               = 'area_manage.php?act=list';
// //$modules['05_system']['06_plugins']                 = 'plugins.php?act=list';
// $modules['05_system']['07_cron_schcron']            = 'cron.php?act=list';
// $modules['05_system']['08_friendlink_list']         = 'friend_link.php?act=list';
// $modules['05_system']['sitemap']                    = 'sitemap.php';
// $modules['05_system']['check_file_priv']            = 'check_file_priv.php?act=check';
// $modules['05_system']['captcha_manage']             = 'captcha_manage.php?act=main';
// $modules['05_system']['ucenter_setup']              = 'integrate.php?act=setup&code=ucenter';
// $modules['05_system']['flashplay']                  = 'flashplay.php?act=list';
// $modules['05_system']['navigator']                  = 'navigator.php?act=list';
// $modules['05_system']['file_check']                 = 'filecheck.php';
// //$modules['05_system']['fckfile_manage']             = 'fckfile_manage.php?act=list';
// $modules['05_system']['021_reg_fields']             = 'reg_fields.php?act=list';
...
$modules['13_backup']['03_db_optimize']             = 'category.php?act=send';
...
// $modules['17_activity']['lottery']           = 'lottery.php?act=index';

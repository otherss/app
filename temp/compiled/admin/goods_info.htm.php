...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
		...
		<span
        class="tab-back" id="gallery-tab">相册</span>
		<!--
		<span
        class="tab-back" id="linkgoods-tab">关联商品</span>
		
		<?php if ($this->_var['goods_type_list']): ?><span
        class="tab-back" id="properties-tab"><?php echo $this->_var['lang']['tab_properties']; ?></span><?php endif; ?>
		-->
      </p>
    </div>
      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          <tr>
			...
			<!-- <div style="background-color:<?php echo $this->_var['goods_name_color']; ?>;float:left;margin-left:2px;" id="font_color" onclick="ColorSelecter.Show(this);"><img src="images/color_selecter.gif" style="margin-top:-1px;" /></div><input type="hidden" id="goods_name_color" name="goods_name_color" value="<?php echo $this->_var['goods_name_color']; ?>" />&nbsp;
			             -->
...
?>
         ...
         <!--  <tr>
		  ...
		  <input type="hidden" name="give_integral" value="<?php echo $this->_var['goods']['give_integral']; ?>" size="20" />
		  <input type="hidden" name="rank_integral" value="<?php echo $this->_var['goods']['rank_integral']; ?>" size="20" />
         <!--  <tr>
		  ...
		  <input type="hidden" name="integral" value="<?php echo $this->_var['goods']['integral']; ?>" size="20" onblur="parseint_integral()";/>
        ...
        <!--   <tr id="auto_thumb_1">
		  ...
		  <input type="hidden" id="auto_thumb" name="auto_thumb" value="1"  />
		   <tr>
        ...
        <table width="90%" id="linkgoods-table" style="display:none" align="center">
          ...
          <tr>
            <td colspan="3">
			  ...
			  <input type="hidden" name="brand_id1"   value="0"/>

...
<div id="topbar">
  <div align="right">
  	<a href="" onclick="closebar(); return false"><img src="images/close.gif" border="0" /></a></div>
...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td><?php echo empty($this->_var['order']['user_name']) ? $this->_var['lang']['anonymous'] : $this->_var['order']['user_name']; ?> <?php if ($this->_var['order']['user_id'] > 0): ?>[ <a href="" onclick="staticbar();return false;"><?php echo $this->_var['lang']['display_buyer']; ?></a> ] 
	<!-- 
	[ <a href="user_msg.php?act=add&order_id=<?php echo $this->_var['order']['order_id']; ?>&user_id=<?php echo $this->_var['order']['user_id']; ?>"><?php echo $this->_var['lang']['send_message']; ?></a> ]
	 -->
	<?php endif; ?></td>
  ...
  <tr>
	...
	<!-- 
	<a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=payment" class="special"><?php echo $this->_var['lang']['edit']; ?></a>
	 
    (<?php echo $this->_var['lang']['action_note']; ?>: <span onclick="listTable.edit(this, 'edit_pay_note', <?php echo $this->_var['order']['order_id']; ?>)"><?php if ($this->_var['order']['pay_note']): ?><?php echo $this->_var['order']['pay_note']; ?><?php else: ?>N/A<?php endif; ?></span>)
	-->
	</td>
  ...
  <tr>
	...
	<!-- 
	<a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=shipping" class="special"><?php echo $this->_var['lang']['edit']; ?></a>&nbsp;&nbsp;
	 -->
	<!-- 
	<input type="button" onclick="window.open('order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>&shipping_print=1')" class="button" value="<?php echo $this->_var['lang']['print_shipping']; ?>"> <?php if ($this->_var['order']['insure_fee'] > 0): ?>（<?php echo $this->_var['lang']['label_insure_fee']; ?><?php echo $this->_var['order']['formated_insure_fee']; ?>）<?php endif; ?>
	 -->
	<?php endif; ?></td>
  ...
  <tr>
    ...
    <td><?php if ($this->_var['order']['shipping_id'] > 0 && $this->_var['order']['shipping_status'] > 0): ?><span><?php if ($this->_var['order']['invoice_no']): ?><?php echo $this->_var['order']['invoice_no']; ?><?php else: ?>N/A<?php endif; ?></span>
	<!-- 
	<a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=shipping" class="special"><?php echo $this->_var['lang']['edit']; ?></a>
	 -->
	<?php endif; ?></td>
  ...
  <tr> 
    ...
    <td><?php echo htmlspecialchars($this->_var['order']['consignee']); ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=consignee" class="special"><?php echo $this->_var['lang']['edit']; ?></a></td>
  ...
  <tr> 
    ...
    <td  ><?php echo htmlspecialchars($this->_var['order']['tel']); ?></td>
...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <th><?php echo $this->_var['lang']['fee_info']; ?>
	<!-- 
	<a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=money" class="special"><?php echo $this->_var['lang']['edit']; ?></a>
	 -->
	</th>
  </tr>
  <!--
 ...
 - <?php echo $this->_var['lang']['label_discount']; ?><strong><?php echo $this->_var['order']['formated_discount']; ?></strong>     + <?php echo $this->_var['lang']['label_tax']; ?><strong><?php echo $this->_var['order']['formated_tax']; ?></strong> 
  ...
  <tr>
    <td><div align="right">
    	 <?php echo $this->_var['lang']['label_order_amount']; ?><strong><?php echo $this->_var['order']['formated_total_fee']; ?></strong>

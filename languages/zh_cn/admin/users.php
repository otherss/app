...
$_LANG['label_pay_points_gt'] = '会员积风大于';
$_LANG['label_pay_points_lt'] = '会员积风小于';
...
$_LANG['notice_pay_points'] = '消费积风是一种站内货币，允许用户在购物时支付一定比例的积风。';
$_LANG['notice_rank_points'] = '等级积风是一种累计的积风，系统根据该积风来判定用户的会员等级。';
...
$_LANG['js_languages']['invalid_pay_points'] = '消费积风数不是一个整数。';
$_LANG['js_languages']['invalid_rank_points'] = '等级积风数不是一个整数。';

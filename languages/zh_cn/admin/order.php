...
$_LANG['pay_points_not_enough'] = '用户积风不足';
...
$_LANG['change_use_integral'] = '编辑订单 %s ，改变使用积风支付的数量';
$_LANG['return_order_surplus'] = '由于取消、无效或退货操作，退回支付订单 %s 时使用的预付款';
$_LANG['return_order_integral'] = '由于取消、无效或退货操作，退回支付订单 %s 时使用的积风';
$_LANG['order_gift_integral'] = '订单 %s 赠送的积风';
$_LANG['return_order_gift_integral'] = '由于退货或未发货操作，退回订单 %s 赠送的积风';

...
$_LANG['integral_min_exists'] = '已经存在一个等级积风下限为 %d 的会员等级';
$_LANG['integral_max_exists'] = '已经存在一个等级积风上限为 %d 的会员等级';

/* JS 语言 */
$_LANG['js_languages']['remove_confirm'] = '您确定要删除选定的会员等级吗？';
$_LANG['js_languages']['rank_name_empty'] = '您没有输入会员等级名称。';
$_LANG['js_languages']['integral_min_invalid'] = '您没有输入积风下限或者积风下限不是一个整数。';
$_LANG['js_languages']['integral_max_invalid'] = '您没有输入积风上限或者积风上限不是一个整数。';
$_LANG['js_languages']['discount_invalid'] = '您没有输入折扣率或者折扣率无效。';
$_LANG['js_languages']['integral_max_small'] = '积风上限必须大于积风下限。';

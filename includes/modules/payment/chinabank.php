...
class chinabank
{
    ...
    function get_code($order, $payment)
    {
        ...
        $def_url  = '<form style="text-align:center;display:inline-block;" method=post action="https://pay3.chinabank.com.cn/PayGate" target="_blank">';
        ...
        $def_url .= "<div class='btn_pay'><input type=submit value='网银支付'></div>";
        $def_url .= "</form>";

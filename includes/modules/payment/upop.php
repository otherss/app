...
class UPOP
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button = "<div class='btn_pay'><input type='submit' value='在线支付' /></div>";
    ...
    */
    ...
    <form style="text-align:center;display:inline-block" id="pay_form" name="pay_form" action="{$front_pay_url}" method="post" target="_blank">
eot;
